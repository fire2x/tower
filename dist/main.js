! function(e) {
	...
	t.drawYellowString = function(e, t) {
		...
		l.addColorStop(0, "#FAD961"), l.addColorStop(1, "#F76B1C"), s.fillStyle = l, s.lineWidth = u, s.strokeStyle = "#FFF", s.textAlign = o || "center", s.font = "".concat(c, "px ").concat("微軟正黑體"), s.strokeText(i, a, r), s.fillText(i, a, r), s.restore()
	}
}, function(e, t, i) {
	"use strict";
	Object.defineProperty(t, "__esModule", {
				...
				case a.drop:
					...
					switch (l) {
						...
						case 5:
							...
							(0, n.addSuccessCount)(t), t.setTimeMovement(a.moveDownMovement, 500), 10 !== g && 15 !== g || t.setTimeMovement(a.lightningMovement, 150), e.y = d, c.y = d, c.x = o.x - o.calWidth, c.collisionX = c.x + o.width;
							var f = .3 * o.width;
	...
	window.TowerGame = function() {
		...
		f.swapLayer(0, 1), f.addImg("tutorial", v("tutorial.png")), f.addImg("tutorial-arrow", v("tutorial-arrow.png")), f.addImg("heart", v("heart.png")), f.addImg("score", v("score.png")), f.addAudio("drop-perfect", v("drop-perfect.mp3")), f.addAudio("drop", v("drop.mp3")), f.addAudio("game-over", v("game-over.mp3")), f.addAudio("rotate", v("rotate.mp3")), f.addAudio("bgm", v("bgm.mp3")), f.setVariable(l.blockWidth, .25 * f.width), f.setVariable(l.blockHeight, .71 * f.getVariable(l.blockWidth)), f.setVariable(l.cloudSize, .3 * f.width), f.setVariable(l.ropeHeight, .4 * f.height), f.setVariable(l.blockCount, 0), f.setVariable(l.successCount, 0), f.setVariable(l.failedCount, 0), f.setVariable(l.gameScore, 0), f.setVariable(l.hardMode, !1), f.setVariable(l.gameUserOption, e);
		for (var y = 1; y <= 4; y += 1) {
